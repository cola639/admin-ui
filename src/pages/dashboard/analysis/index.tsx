        ...
        series: [
          {
            name: "Natural",
            data: [
              40000, 60000, 90000, 100000, 80000, 70000, 60000, 50000, 70000, 90000, 80000, 90000,
            ],
          },
          {
            name: "Referral",
            data: [
              30000, 40000, 50000, 60000, 50000, 40000, 30000, 40000, 50000, 60000, 50000, 40000,
            ],
          },
          {
            name: "Direct",
            data: [
              50000, 60000, 40000, 30000, 40000, 50000, 60000, 70000, 80000, 70000, 60000, 50000,
            ],
          },
        ],
        categories: [
        ...
        series: [
          {
            name: "Natural",
            data: [
              400000, 600000, 900000, 1000000, 800000, 700000, 600000, 500000, 700000, 900000,
              800000, 900000,
            ],
          },
          {
            name: "Referral",
            data: [
              300000, 400000, 500000, 600000, 500000, 400000, 300000, 400000, 500000, 600000,
              500000, 400000,
            ],
          },
          {
            name: "Direct",
            data: [
              500000, 600000, 400000, 300000, 400000, 500000, 600000, 700000, 800000, 700000,
              600000, 500000,
            ],
          },
        ],
        ...
        series: [
          {
            name: "Natural",
            data: [
              50000, 60000, 65000, 67000, 62000, 64000, 66000, 68000, 69000, 70000, 71000, 72000,
            ],
          },
          {
            name: "Referral",
            data: [
              40000, 42000, 43000, 44000, 45000, 46000, 47000, 48000, 49000, 50000, 51000, 52000,
            ],
          },
          {
            name: "Direct",
            data: [
              45000, 47000, 48000, 49000, 50000, 51000, 52000, 53000, 54000, 55000, 56000, 57000,
            ],
          },
        ],
        categories: [
          ...
          <CardContent className="flex flex-col gap-2">
            ...
            <div className="w-full min-h-[200px] mt-2">
              <Chart
                ...
                series={webAnalytic.chart.series}
              />
            </div>
          </CardContent>
        </Card>
