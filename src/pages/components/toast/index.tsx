      ...
      <Card title="Position">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              variant="outline"
              onClick={() => toast.info("Toast Info", { position: "bottom-right" })}
            >
              Bottom Right
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.info("Toast Info", { position: "bottom-center" })}
            >
              Bottom Center
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.info("Toast Info", { position: "bottom-left" })}
            >
              Bottom Left
            </Button>
          </div>
